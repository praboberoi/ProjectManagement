...
//        StreamObserver<UploadUserProfilePhotoRequest> streamObserver = this.userAccountStub.uploadUserProfilePhoto(new UserProfilePhotoService.FileUploadObserver());
//
