...
INSERT IGNORE INTO evidence (evidence_id, date_occurred, description, owner_id, title, project_id) VALUES (2, CURRENT_DATE, 'Cypress description', 1285325, 'Cypress', 1000);
INSERT IGNORE INTO evidence (evidence_id, date_occurred, description, owner_id, title, project_id) VALUES (3, CURRENT_DATE, 'Cypress description 2', 1285325, 'Cypress 2', 1000);