Feature: U13. Modifying pieces of evidence
  ...
  Scenario: AC2. Clicking on this icon allows me to edit this piece of evidence. It should be obvious that I am in edit mode. The buttons for save and cancel appear; the save button is initially visible but disabled. The save button is only enabled if the piece of evidence has been modified in some way. In the edit mode, the edit icon is not visible.
